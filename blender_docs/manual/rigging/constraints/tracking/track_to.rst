...
the :doc:`Inverse Kinematics constraint </rigging/constraints/tracking/ik_solver>` in some ways.
...
.. figure:: /images/rigging_constraints_tracking_track-to_panel.png
