...
Be sure to check the :doc:`/about/style_guides/writing_guide`
for conventions and :doc:`/about/style_guides/markup_guide`
...
To **view** your changes, build the manual :doc:`as instructed </about/contribute/install/index>`.
...
After, you can commit your changes directly. This process is described in the next section.
