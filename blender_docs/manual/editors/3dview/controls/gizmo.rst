...
The way how gizmos are displayed in the 3D View can be changed in the 
Viewport Gizmos pop-over. There is a switch to turn off all gizmos for the 
3D View.
...
Empties
    ...
    Force Field
        Show the gizmo to adjust the forcefield
...
Camera
    ...
    Lens
        Show the gizmo to adjust the lens and ortho size
    Focus Distance
