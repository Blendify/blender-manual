...
Transparent Shadows
   Use transparent shadows if it contains a :doc:`Transparent BSDF </render/engines/cycles/nodes/types/shaders/transparent>`,
...
Pass Index
   Index number for the *Material Index* :doc:`render pass </render/engines/cycles/settings/scene/render_layers/passes>`.
