...
please refer to the Manual page on :doc:`Edge and Face Tools </modeling/meshes/selecting#advanced_selection_tools>`.
...
:doc:`Edge Loop Selection </modeling/meshes/selecting#edge_loop_selection>`.
...
:doc:`Face Loop Selection </modeling/meshes/selecting#face_loop_selection>`.
