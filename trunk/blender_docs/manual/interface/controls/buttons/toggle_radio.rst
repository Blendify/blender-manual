...
On checkboxes a the tick is shown when the option is activated.
...
Some toggle buttons have icon version for each state.
...
Cycling works also for number button and selects menus.
