...
.. seealso::
   ...
   the :doc:`Light Paths </render/engines/cycles/settings/scene/render/light_paths>` and
   :doc:`Integrator </render/engines/cycles/settings/scene/render/integrator>` documentation.
...
Multiple Importance Sampling (:doc:`/render/engines/cycles/materials/settings`).
...
To use this enable :doc:`Denoising </render/engines/cycles/settings/scene/render_layers/denoising>`
