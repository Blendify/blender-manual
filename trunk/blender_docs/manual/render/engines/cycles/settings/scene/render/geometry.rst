...
These settings are used to control :doc:`Adaptive Subdivision </render/engines/cycles/settings/objects/adaptive_subsurf>`.
...
.. seealso::
   ...
   in the :doc:`Hair Settings </render/engines/cycles/settings/objects/hair>`.
