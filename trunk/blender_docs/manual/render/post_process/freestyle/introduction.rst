...
The two operating modes: :doc:`Python Scripting </render/post_process/freestyle/python>` and
:doc:`Parameter Editor </render/post_process/freestyle/parameter_editor/index>` --
