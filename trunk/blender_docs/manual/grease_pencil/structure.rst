...
The main element used in editing Grase Pencil Object are points.
...
Further details on working with *Grease Pencil* layers can be found in :doc:`2D Layers </grease_pencil/properties/layers>`.