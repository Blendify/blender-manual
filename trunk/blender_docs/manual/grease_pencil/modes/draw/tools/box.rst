...
or use :kbd:`Alt` to create the box from a center origin.

:kbd:`+` and :kbd:`-` or using the mouse wheel will increase or decrease the amount of points in the final box.
