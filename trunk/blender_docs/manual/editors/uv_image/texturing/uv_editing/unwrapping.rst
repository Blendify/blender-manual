...
The next sections cover :doc:`Editing UVs </editors/uv_image/texturing/uv_editing/layout_editing>`,
followed by methods of :doc:`Managing UV Layouts </editors/uv_image/texturing/uv_editing/layout_management>`,
and :doc:`Applying Images to UVs </editors/uv_image/texturing/uv_editing/applying_image>`.
...
you can :doc:`edit them </editors/uv_image/texturing/uv_editing/layout_editing>`.
...
- Add a test image to see if there will be any distortion.
  See :doc:`Applying Images to UVs </editors/uv_image/texturing/uv_editing/applying_image>`
- Adjust UVs in the UV editor.
  See :doc:`Editing UVs </editors/uv_image/texturing/uv_editing/layout_editing>`
...
New UV Layer
   ...
   See :doc:`Managing the Layout </editors/uv_image/texturing/uv_editing/layout_management>`.
New Image
