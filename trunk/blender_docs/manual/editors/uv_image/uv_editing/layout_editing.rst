...
:doc:`Snapping in 3D </editors/3dview/object/transform/control/precision/snap>`.
...
See :doc:`Proportional Editing in 3D </editors/3dview/object/transform/control/proportional_edit>`
for full reference.
